  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Newsletter Section */}
        <section className="my-12 sm:my-20 rounded-[1.5rem] sm:rounded-[2.5rem] bg-card p-6 sm:p-12 md:p-16 text-center animate-scale-in">
          <div className="max-w-2xl mx-auto space-y-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">Stay inspired.</h2>

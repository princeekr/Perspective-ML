      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-muted rounded-[2.5rem]">
        ...
        <div className="absolute inset-0 p-4 sm:p-6 md:p-8 flex flex-col justify-between">
          ...
          <div className="flex items-start justify-between gap-2">
            <span className={`px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-medium backdrop-blur-md ${getCategoryClass(category)} bg-opacity-80`}>
              {category}
            </span>
            <span className="px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-white/20 backdrop-blur-md text-[10px] sm:text-xs font-medium text-white border border-white/30">
              {date}
            </span>
          </div>
          ...
          <div className="flex items-end justify-between gap-3 sm:gap-4">
            <div className="flex-1 min-w-0">
              <span className="text-white/50 text-[10px] sm:text-xs font-medium tracking-wider block mb-2 sm:mb-3">{id}</span>
              <h3 className="text-white text-base sm:text-xl md:text-2xl lg:text-3xl font-bold leading-tight tracking-tight">
                {title}
              </h3>
            </div>
          </div>
        ...
        <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 floating-button">
